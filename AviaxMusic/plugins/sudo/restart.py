...
@app.on_message(filters.command(["vgetlog", "vlogs", "vgetlogs"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["vupdate", "vgitpull"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["vrestart"]) & SUDOERS)
