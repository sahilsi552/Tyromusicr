...
@app.on_message(filters.command(["vgban", "vglobalban"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["vungban"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["vgbannedusers", "vgbanlist"]) & SUDOERS)
@language
